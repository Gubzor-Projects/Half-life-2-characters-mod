...
namespace UmmAPI
{
    public static class UmAPI 
    {
        ...
        public static void CreateMaskObject(this GameObject parent, Sprite sprite, Color maskColor, float maskIntensity, Color glowColor, float glowRadius, float glowIntensity, Vector3 offset, bool onTop = false)
        {
